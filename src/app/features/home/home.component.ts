        ...
        <div class="flex flex-col md:flex-row items-center gap-12">
          <div class="flex-1 space-y-8 text-center md:text-left">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-4 flex-wrap">
              <a routerLink="/portfolio" class="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full font-bold text-lg transition-all shadow-lg shadow-indigo-600/20 hover:shadow-indigo-600/40 transform hover:-translate-y-1">
