  ...
  template: `
    <footer class="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-8 transition-colors duration-300">
      <div class="container mx-auto px-4 text-center text-gray-600 dark:text-gray-400">
        <p>&copy; {{ year }} Soufiane Chajjaoui. All rights reserved.</p>
        <div class="flex justify-center gap-6 mt-4">
          ...
          <a href="https://medium.com/@schajjaoui" class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Medium</a>
        </div>
      </div>
    </footer>
  `
